...
# from scripts.finetune_polyhaven import evaluate, prepare_model, transform
# from scripts.finetune_render_pretrained import evaluate, prepare_model, transform
# from scripts.finetune_polyhaven import evaluate, prepare_model, transform
from scripts.finetune_controlnet import evaluate, prepare_model, transform
...
config = omegaconf.OmegaConf.load('./configs/finetune_controlnet.yaml')
# config = omegaconf.OmegaConf.load('./configs/finetune_polyhaven.yaml')
...
save_dir = os.path.join('eval', time.strftime("controlnet_%Y-%m-%d %H:%M:%S", current_time))
