...
from .attn_ref import CrossAttnDownBlock2DReference


class UNet2DConditionModelReference(
    ...
    def __init__(
        ...
        if isinstance(cross_attention_dim, int) or cross_attention_dim is None:
    ...
    def forward(
        ...
        if self.mid_block is not None:
            if hasattr(self.mid_block, "has_cross_attention") and self.mid_block.has_cross_attention:
                sample, attn_states = self.mid_block(
                    sample,
                    emb,
                    encoder_hidden_states=encoder_hidden_states,
                    attention_mask=attention_mask,
                ...
                sample, attn_states = self.mid_block(sample, emb)
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                sample, attn_states = upsample_block(
                    hidden_states=sample,
                    temb=emb,
